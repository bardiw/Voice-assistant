...
while True:
    ...
    if "wikipedia" in command:
        ...
        webbrowser.open_new_tab("https://www.gmial.com")
        print("Opening Gmail.\n")
        speak("Opening Gmail.")
        time.sleep(5)
        ...
        print("Hello. I am version 1 of the voice assistant and was programmed by Bardia.\n")
        speak("Hello. I am version 1 of the voice assistant and was programmed by Bardia.")
    elif "write note" in command:
        print(f"What should I write for you {NAME}?\n")
        speak(f"What should I write for you {NAME}?")
        note = take_command()
        print(f"{NAME}, should I include time?\n")
        speak(f"{NAME}, should I include time?")
        ans = take_command()
        if "y" in ans:
            strt_time = datetime.datetime.now().strftime("%H:%M:%S")
            with open("note.txt", "w") as file:
                file.write(strt_time + "\n")
                file.write("-" * 40 + "\n")
                file.write(note)
        else:
            with open("note.txt", "w") as file:
        ...
        os.startfile(r"C:\Users\daneshjoo\AppData\Roaming\Telegram Desktop\Telegram.exe")
        time.sleep(5)
    elif "logout" in command:
        print("Your systen will log out after 5 seconds!\n")
        speak("Your systen will log out after 5 seconds!")
        time.sleep(5)
        subprocess.call(["shutdown", "/l "])
    elif "weather" in command:
        api_key = "a86880b2710a8b4895390646e5474e7a"
